...
import recipe4Img from "@/assets/recipe-1.jpg";
...
export const recipes: Recipe[] = [
  ...
  prepTime: "20 mins",
  serves: "5",
  description: "A flavorful and aromatic rice dish made with tender chicken, basmati rice, and traditional Indian spices.",
  ingredients: [
    {
      category: "Main Ingredients",
      items: [
  ...
  keywords: ["Indian", "Rice Dish", "Spicy", "Popular"]
},
  {
  ...
  prepTime: "15 mins",
  serves: "4",
  description: "A rich and creamy North Indian curry made with soft paneer cubes simmered in a buttery tomato-based gravy. Perfect with naan or rice.",
  ingredients: [
    {
      category: "Main Ingredients",
      items: [
  ...
  instructions: [
    ...
    "Add spices, salt, and cream. Mix well.",
  ...
  keywords: ["Vegetarian", "Indian", "Creamy", "Popular"]
},
 {
    id: "dal-makhani",
    title: "Dal Makhani",
